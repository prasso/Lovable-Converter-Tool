import { escapeSQLString, escapeSQLHTML, escapeSQLBoolean, escapeSQLInt, } from './utils/escapeSQL.js';
/**
 * Generate a section name from component name
 */
function generateSection(componentName) {
 ...
 */
export function convertPageToRecord(page, siteId) {
    return {
        fk_site_id: siteId,
 ...
 */
export function generateInsertStatement(record) {
    const columns = [
        'fk_site_id',
        'section',
        'title',
 ...
 */
export function generateSQL(pages, siteId) {
    const statements = [];
    // Add header comment
 ...
 */
export function generateSQLWithTransaction(pages, siteId) {
